...
class Base_Agent(object):
    ...
    def __init__(self, config):
        ...
        self.writer = SummaryWriter(comment='-'+self.environment_title +TIME)
    ...
    def run_n_episodes(self, num_episodes=None, show_whether_achieved_goal=True, save_and_print_results=True):
        ...
        while self.episode_number < num_episodes:
            ...
            self.writer.add_scalar("AvgRewards_10",self.rolling_results[-1],self.episode_number)
            self.writer.add_scalar("Reward",self.game_full_episode_scores[-1],self.episode_number)
    ...
    def take_optimisation_step(self, optimizer, network, loss, clipping_norm=None, retain_graph=False):
        ...
        self.writer.add_scalar("loss",loss,self.episode_number)
